...
- [ ] funlex: .funl 호환 입력을 받아 .fun lexer 모듈을 생성
- [ ] funyacc: .funy 호환 입력을 받아 .fun LALR(1) parser 모듈을 생성
...
- Lexer.funl과 Parser.fsy가 FsLexYacc에 의존하고 있음
...
- **입력 호환성**: .funl/.funy 형식과 호환되어야 함 — 기존 LangThree의 lexer/parser 정의를 그대로 사용하기 위해
...
|----------|-----------|---------|
| .funl/.funy 호환 문법 사용 | 기존 LangThree 정의 파일을 변경 없이 재사용 | — Pending |
