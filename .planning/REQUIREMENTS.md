...
- [ ] **FLEX-01**: .funl 포맷 파싱 — FsLexYacc 호환 입력 형식의 재귀 하강 파서
...
- [ ] **FYAC-01**: .funy 포맷 파싱 — FsLexYacc 호환 입력 형식의 재귀 하강 파서
...
- [ ] **CGEN-02**: 시맨틱 액션 임베딩 — .funl/.funy의 { } 액션 블록을 생성 코드에 포함 (opaque 처리)
- [ ] **CGEN-03**: LALR 인터프리터 인라인 — Parser.fun에 파싱 런타임(스택 기반 shift/reduce 엔진) 포함

### Bootstrap

- [ ] **BOOT-01**: funlex/funyacc로 LangThree의 Lexer.funl/Parser.funy를 처리하여 Lexer.fun/Parser.fun 생성
...
- **SELF-01**: funlex/funyacc가 자기 자신의 .funl/.funy 파서를 생성 (meta-bootstrapping)
